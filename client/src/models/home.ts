...
export const defaultExpertiseContent = {
...
export const defaultIndustryExpertise = {
  mainHeading: 'INDUSTRY EXPERTISE',
  text: 'Our services are designed to address several sectors. We have extensive experience and offer hands-on solutions to, including but not limited, the following industries.',
  contentList: [
    {
      heading: 'SOFTWARE',
      id: 0,
