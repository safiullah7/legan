...
import CookiePolicyForm from './CookiePolicyForm';
                    ...
                    {!editMode ? (
                        <>
                            <DivPrivacyContent>
                                ...
                                <p>Effective:  {policy && (
                                    <Moment format="YYYY/MM/DD" date={policy?.cookiePolicy.effectiveDate!} />
                                )} </p>
                            </DivPrivacyContent>
                            <DivPrivacyDescription>
                                {parse(policy === null ? '' : policy?.cookiePolicy.content)}
                            </DivPrivacyDescription>
                        </>
                    ) : (
                        <>
                            <CookiePolicyForm policy={policy} setEditMode={setEditMode} />
                        </>
                    )}
                </Container>
            </DivPrivacy>
