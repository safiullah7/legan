                    ...
                    {!editMode ? (
                        <>
                            <DivPrivacyContent>
                                ...
                                <p>Effective:  {policy && (
                                    <Moment format="YYYY/MM/DD" date={policy?.termsAndConditions.effectiveDate!} />
                                )} </p>
                            </DivPrivacyContent>
                            <DivPrivacyDescription>
                                {parse(policy === null ? '' : policy?.termsAndConditions.content)}
                            </DivPrivacyDescription>
                        </>
                    ) : (
                        <>
                            <TermsAndConditionsForm policy={policy} setEditMode={setEditMode} />
                        </>
                    )}
                </Container>
            </DivPrivacy>
